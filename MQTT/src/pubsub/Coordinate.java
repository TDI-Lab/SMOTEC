...
import java.util.List;
	...
	public class Coordinate { // extends Map {
		...
		public static void disableSmartThing(User smartThing) {
		...
		public static void newCoordinate(User smartThing) {
	...
	//zeinab
		...
		public static void newCoordinate(User smartThing, int add, Coordinate coordDevices) {
